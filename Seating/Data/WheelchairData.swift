...
let wheelchairData: [Wheelchair] = [
    Wheelchair(
        ...
        headline: "STD wheelchair is selected to be use with people with adequate head and trunk control",
        image:"STD",
 ...
 """),
    ...
    Wheelchair(
        ...
        headline: "HTR wheelchair is selected to be use with people that requiere extensive support ",
        image:"HTR",
 ...
 """),
    Wheelchair(
        ...
        headline: "TIS wheelchair is selected to be use with people that need pressure relief and trunk support",
        image:"TIS",
 ...
 """),
    Wheelchair(
        ...
        headline: "Therapeutic Seating Range. All of our products have been developed and engineered to offer optimum quality, safety, pressure management and support for both patients and caregivers. ",
        image:"milano",
